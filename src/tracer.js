...
export default class Tracer {
  ...
  registerInjector(format, injector) {
    this._injectors[format] = injector
  }

  registerExtractor(format, extractor) {
  ...
  startSpan(operationName, options) {
    ...
    let parent = options.childOf instanceof Span ? options.childOf.context() : options.childOf
